...
class AdminRuangKelasController extends Controller
{
    /**
    ...
    public function index(Request $data)
    {
        ...
        $ruangkelas = RuangKelas::where('status', '!=', true)
            ->where('ruangkelas_code', 'like', '%' . $search . '%')
            ->orWhere('ruangkelas_kapasitas', 'like', '%' . $search . '%')
            ->orWhere('ruangkelas_prodi', 'like', '%' . $search . '%')
            ->orWhere('ruangkelas_status', 'like', '%' . $search . '%')
            ->get();
        }
    ...
    {
        $ruangkelas = RuangKelas::where('ruangkelas_code', $id);
        $ruangkelas->update(['status'=> false]);
