        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-8 w-auto" src="{{ asset('logo-UPK.svg') }}" alt="Your Company">
            </div>
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="#" class="text-gray-800 font-bold rounded-md px-3 py-2 text-sm"
                  aria-current="page">Dashboard</a>
                <a href="#"
                  class="text-gray-500 hover:text-gray-800 rounded-md px-3 py-2 text-sm font-medium">Peminjaman</a>
                <a href="#"
                  class="text-gray-500 hover:text-gray-800 rounded-md px-3 py-2 text-sm font-medium">Jadwal</a>
                <a href="#"
                  class="text-gray-500 hover:text-gray-800 rounded-md px-3 py-2 text-sm font-medium">Riwayat</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button"
                    class="relative flex max-w-xs items-center rounded-full bg-cyan-500 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
              ...
              -->
                <div
                  ...
                  <p class="block px-4 py-2 text-sm text-gray-300 font-semibold" role="menuitem" tabindex="-1">Nama Username</p>
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="#" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"
            aria-current="page">Dashboard</a>
          <a href="#"
            class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Peminjaman</a>
          <a href="#"
            class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Jadwal</a>
          <a href="#"
            class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Riwayat</a>
        </div>
