...
<form action="{{ route('register.personal.store') }}" method="post">
	...
	<div class="w-full mt-5 grid grid-cols-2 gap-5">
		...
		<div class="row-span-1">
			...
			<div class="mt-2">
				<input type="phone" name="phone" id="phone" autocomplete="given-name" required value="{{ old('phone') }}" class="block w-full rounded-md border-0 pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6
		...
		<div class="row-span-1">
			...
			<div class="mt-2">
				<input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}" class="block w-full rounded-md border-0 pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6
