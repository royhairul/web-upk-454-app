...
<body class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-cyan-500">Beranda</a>
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-cyan-500">Panduan</a>
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-cyan-500">Tentang</a>
            </div>
    ...
    <div class="relative isolate px-4 pt-6 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div
                    ...
                    Announcing our next round of funding. <a href="#" class="font-semibold text-cyan-600"><span
            ...
            <div class="text-center">
                ...
                <p class="mt-16 text-lg leading-8 text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui
