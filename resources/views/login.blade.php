  ...
  <div class="container p-10 mx-auto">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="password" name="password" type="password" autocomplete="current-password" required
              class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-outset focus:ring-cyan-600 sm:text-sm sm:leading-6">
          </div>
        </div>

        <div>
          <button type="submit"
            class="flex w-full justify-center rounded-md bg-cyan-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600">Log
            In</button>
        </div>
      </form>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Belum punya Akun?
        <a href="{{ route('register') }}" class="font-semibold leading-6 text-cyan-600 hover:text-cyan-500">Register</a>
        terlebih dahulu
      </p>
    </div>
  </div>
