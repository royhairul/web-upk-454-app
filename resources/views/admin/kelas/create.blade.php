...
<form action="{{ route('admin.kelas.store') }}" method="post">
  @csrf
  <h2 class="mt-10 text-2xl font-bold leading-9 tracking-tight text-gray-900 ">Buat Data Kelas Baru</h2>
  <p class="text-base leading-9 tracking-tight text-gray-400">
    Membuat Data untuk Ruang Kelas.
  </p>
  <div class="w-full mt-5 grid grid-cols-2 gap-5">
    ...
    <div class="row-span-1">
      ...
      <div class="mt-2">
        <input id="kapasitas" name="kapasitas" type="text" required value="{{ old('kapasitas') }}" class="block w-full rounded-md border-0 pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6
