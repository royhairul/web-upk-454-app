      ...
      <table class="border-collapse table-auto w-full text-sm">
        ...
        <tbody class="bg-white dark:bg-slate-800">
          ...
          <tr>
            ...
            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                <a href="{{ route('admin.pengembalian.verif', $id = $p->peminjaman_id) }}"
                  class="font-semibold text-rose-600 leading-2 flex bg-rose-50 px-2 py-1 justify-center items-center gap-x-2 rounded-md
                         hover:bg-rose-100 hover:text-rose-700 transition-colors duration-150" id='showButton'>
                  <span>Detail</span>
